...
const files = {
  ...
  'marker-click-command.json': MarkerClickCommandSchema,
  'marker-click-accepted.json': MarkerClickAcceptedSchema,
  ...
  'discuss-proposal-command.json': DiscussProposalCommandSchema,
  'discuss-proposal-accepted.json': DiscussProposalAcceptedSchema,
